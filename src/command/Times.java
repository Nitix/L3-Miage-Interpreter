...
/**
 * The Class Times. Multiply two children each other
 */
public class Times extends Command {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 6886150509647981835L;
	...
	/**
	 * Checks if it's a times command.
	 *
	 * @param command
	 *            the command
	 * @return true, if it's a times command
	 */
